...
function bookingDetailsBlock(booking: BookingInfo, serviceLabel: string, bgColor = "#f0fdf4"): string {
  return `<div style="background: ${bgColor}; border-radius: 8px; padding: 16px; margin: 16px 0;">
...
export function confirmationEmail(booking: BookingInfo): { subject: string; html: string } {
  ...
  return {
    ...
    html: layout(`
      ...
      ${bookingDetailsBlock(booking, config.label)}
...
export function cancellationEmail(booking: BookingInfo): { subject: string; html: string } {
  ...
  return {
    ...
    html: layout(`
      ...
      ${bookingDetailsBlock(booking, config.label, "#fef2f2")}
